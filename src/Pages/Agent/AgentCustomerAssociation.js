...
const AgentCustomerAssociation = () => {
                                ...
                                content={
                                    <div style={{ textAlign: "center" }}>
                                        ...
                                        <Button
                                            ...
                                            disabled={record.deal.dealStatus === "inProgress"} // Disable if already in progress
                                        >
                                            Yes
                                        </Button>
                            ...
                            >
                                <div
                                    style={{
                                        ...
                                        border: "none",
                                        borderRadius: "5px",
                                        cursor: record.deal.dealStatus === "inProgress" ? "not-allowed" : "pointer",

                                        transition: "background 0.3s ease",
                                        opacity: record.deal.dealStatus === "inProgress" ? 0.6 : 1,
                                        textAlign: "center",
                                    }}
                                >
                                    {record.deal.dealStatus === "inProgress" ? "Deal Started" : "Start Deal"}
                                </div>
                            </Popover>
                        </Menu.Item>
                        {console.log("Dsds",record)}
                        <Menu.Item
                            onClick={() => {
                                onScheduleMeet(
                                    record.deal._id,
                                    record.agent._id,
                                    record.properties._id,
                                    record.propertyName,
...
export default AgentCustomerAssociation;