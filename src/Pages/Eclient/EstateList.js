            ...
            {paginatedData.map((property, index) => (
              ...
              >
                ...
                >
                  ...
                  <Row>
                    <Col span={16}>
                      {property.status === 0 || property.status === undefined ? (
                        <Button
                          style={{
                            statound:
            ...
            {isModalVis && (
              <Modal
                title={
                  <div className="PropertyStyle">
                    <span>
                      {curEstate.landDetails.landName?.replace(
                        /\b\w/g,
                        (char) => char.toUpperCase()
                      )}
                    </span>
                ...
                open={isModalVis}
                onCancel={() => setIsModalVis(!isModalVis)}
                width={900}
                style={{ marginTop: "-5%" }}
                footer={null}
              >
                <Agents estate={curEstate} setIsModalVis={setIsModalVis} isModalVis={isModalVis} fetchEstates={fetchEstates} />
              </Modal>
            )}
          </Row>
          {estates.length > 6 && (
